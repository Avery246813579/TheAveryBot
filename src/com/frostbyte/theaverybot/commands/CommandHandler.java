...
import com.frostbyte.theaverybot.commands.defaults.trivia.TriviaBoardCommand;
import com.frostbyte.theaverybot.commands.defaults.trivia.TriviaCommand;
import com.frostbyte.theaverybot.commands.defaults.trivia.TriviaRankCommand;
...
public class CommandHandler {
	...
	public CommandHandler(final BotManager botManager) {
		...
		commands.add(new TriviaRankCommand(botManager));
		commands.add(new TriviaBoardCommand(botManager));
