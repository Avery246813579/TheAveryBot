...
public class TriviaUpdator extends AutoUpdator {
	public int type_id;

	public TriviaUpdator(int type_id) {
		super("Trivia", TriviaHandler.trivias.get(type_id).getVersion());
	...
	public boolean canUpdate() {
		...
		String tVersion = ObjectUtil.objectToString(SqlHandler.trivia_Type.get("type_id", type_id).get(0).get("version"));
		String sVersion = "";
